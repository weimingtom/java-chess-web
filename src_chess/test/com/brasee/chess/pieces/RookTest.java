...
public class RookTest {
	...
	public void testRookCanMoveLeft() {
		...
		assertTrue(rook.canMove(null, currentSquare, emptySquare));	
	}
	...
	public void testRookCannotMoveDiagonal() {
		...
		assertFalse(rook.canMove(null, currentSquare, emptySquare));	
	}
	...
	public void testRookCanAttackLeft() {
		Square currentSquare = new Square("d5");
		Square emptySquare = new Square("a5");
		assertTrue(rook.canAttack(null, currentSquare, emptySquare));	
	}
	...
	public void testRookCannotAttackDiagonal() {
		Square currentSquare = new Square("d5");
		Square emptySquare = new Square("e6");
		assertFalse(rook.canAttack(null, currentSquare, emptySquare));	
	}
	...
	public void testCannotAttackSameSquare() {
		...
		assertFalse(rook.canAttack(null, currentSquare, occupiedSquare));
	}
