...
public class KingTest {
	...
	public void testCanMoveOneSquareStraightUp() {
		...
		assertTrue(king.canMove(null, currentSquare, emptySquare));
	}
	...
	public void testCanAttackOneSquareStraightUp() {
		...
		assertTrue(king.canAttack(null, currentSquare, occupiedSquare));
	}
	...
	public void testCannotMoveMultipleSquares() {
		...
		assertFalse(king.canMove(null, currentSquare, emptySquare));
	}
	...
	public void testCannotAttackSameSquare() {
		...
		assertFalse(king.canAttack(null, currentSquare, occupiedSquare));
	}
}
