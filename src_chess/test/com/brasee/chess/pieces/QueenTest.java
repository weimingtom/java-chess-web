...
public class QueenTest {
	...
	public void testCanMoveStraightUp() {
		...
		assertTrue(queen.canMove(null, currentSquare, emptySquare));
	}
	...
	public void testCanAttackStraightUp() {
		...
		assertTrue(queen.canAttack(null, currentSquare, occupiedSquare));
	}
	...
	public void testCannotMoveToNonStraightOrDiagonalSquare() {
		...
		assertFalse(queen.canMove(null, currentSquare, emptySquare));
	}
	...
	public void testCannotAttackNonStraightOrDiagonalSquare() {
		...
		assertFalse(queen.canMove(null, currentSquare, occupiedSquare));
	}
	...
	public void testCannotAttackSameSquare() {
		...
		assertFalse(queen.canAttack(null, currentSquare, occupiedSquare));
	}
}
