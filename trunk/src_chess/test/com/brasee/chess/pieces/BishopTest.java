...
public class BishopTest {
	...
	public void testCanMoveDiagonallyUpAndLeft() {
		...
		assertTrue(bishop.canMove(null, currentSquare, emptySquare));
	}
	...
	public void testCanAttackDiagonallyUpAndLeft() {
		...
		assertTrue(bishop.canAttack(null, currentSquare, occupiedSquare));
	}
	...
	public void testCannotMoveHorizontally() {
		...
		assertFalse(bishop.canMove(null, currentSquare, emptySquare));		
	}
	...
	public void testCannotAttackSameSquare() {
		...
		assertFalse(bishop.canAttack(null, currentSquare, occupiedSquare));
	}
}
