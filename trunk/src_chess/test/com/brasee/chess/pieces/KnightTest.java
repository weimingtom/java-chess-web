...
public class KnightTest {
	...
	public void testCanMoveUp2Right1() {
		...
		assertTrue(knight.canMove(currentSquare, emptySquare));
	}
	...
	public void testCanAttackUp2Right1() {
		...
		assertTrue(knight.canAttack(currentSquare, occupiedSquare));
	}
	...
	public void testCannotMoveVertically() {
		...
		assertFalse(knight.canMove(currentSquare, emptySquare));
	}
	...
	public void testCannotAttackSameSquare() {
		...
		assertFalse(knight.canAttack(currentSquare, occupiedSquare));
	}
}
